...
import 'EditPayAliPayC.dart';

class EditPayAliPay extends GetView<EditPayAliPayController> {
  EditPayAliPayController payAliPay = Get.put(EditPayAliPayController());
  @override
